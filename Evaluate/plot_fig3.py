...
def main():
    ...
    patient = '252555'  # 2PA047  -- 020.npy  032.npy   # 252505  252406
    item = '056.npy'  # 252456-35   253142-70-66  252930-21
    series_name_list = ['Flow-20step', 'DDIM-20step', 'Unet']

    box = [75, 100, 95, 120]  # hs, he, ws, we  原始值
    box2 = [50, 75, 130, 155]

    box = [75, 105, 92, 122]  # hs, he, ws, we  原始值
    box2 = [45, 75, 125, 155]
